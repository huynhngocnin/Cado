...
public class DialogUntil {
    ...
    public static void showNetworkStage(Context context) {
        createDialogOk(context, context.getString(R.string.network_info), context.getString(R.string.network_connect_fail)).show();
    }
