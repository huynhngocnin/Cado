...
//    private int admobCount = ADMOB_INIT_POSITION;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.tab_item_result, null);
    }
...
//    }
    ...
    private void initRecyclerView() {
        ...
        mRecyclerView = (RecyclerView) getActivity().findViewById(R.id.recycle_result);

        mRecyclerView.setLayoutManager(new LinearLayoutManager(getActivity()));
        matchAdapter = new MatchAdapter(getActivity(), mRecyclerView, matchResultModels, this);
        mRecyclerView.setAdapter(matchAdapter);

        progressBarRefresh = (ProgressBar) getActivity().findViewById(R.id.refresh_result);
...
//                getMatchMore();
    ...
    private void initPullRefresh() {
        ...
        pullRefreshLayout = (PullRefreshLayout) getActivity().findViewById(R.id.pullRefresh_result);
